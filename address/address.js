...
(function() {
	...
	// 这个地方是有点问题的  当地址都被删完了之后 显示的那个按钮是不合理的   
	// 当新用户第一次进入的时候 显示 无地址 没有添加按钮 直接输入信息保存  这个方式有点不合理 
	// 如果和第一次进入的时候要统一  那么删除所有的地址之后 最后一个新增的按钮也应该被删除掉  就这样吧 懒得写了
	if(document.querySelector("ul.address-list").classList.contains("show")){
